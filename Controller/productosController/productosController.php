...
class ProductosController {
	...
	public function getProductosController(){
      $products = new ProductosModel;
		$respuesta = $products->getProductosModel('productos');
   ...
   public function agregarProductosController(){
   	 if (isset($_POST['agregarProductos'])) {
   	 	$datosController = array("nombreproducto"=>$_POST['nombreproducto'],
   	 		                     ...
   	 		                     "precio"=>$_POST['precio']);
         $products = new ProductosModel;
   	 	$respuesta = $products->agregarProductosModel($datosController, 'productos');
   ...
   #pedir la informacion al modelo.
      $products = new ProductosModel;
      $respuesta =  $products->deleteProductosModel($datosController,'productos');
      if ($respuesta == 'success') {
