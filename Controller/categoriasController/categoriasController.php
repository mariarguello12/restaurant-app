...
class CategoriasController {
  ...
  public function agregarCategoriasController(){
      ...
      $categorias = new CategoriasModel;
  	  $respuesta = $categorias->agregarCategoriasModel($datosController,'categorias');
    ...
    public function getCategoriasController(){
      $categorias = new CategoriasModel;
      $respuesta = $categorias->getCategoriasModel('categorias');
    ...
    public function editarCategoriasController(){
            ...
            $categorias = new CategoriasModel;
      $respuesta = $categorias->editarCategoriasModel($datosController,'categorias');
  ...
  echo'  <div class="col-md-8">  
   ...
   public function actualizarCategoriaController(){
         if (isset($_POST['editarCategorias'])) {
          ...
          $categorias = new CategoriasModel;
          $respuesta= $categorias->actualizarCategoriaModel($datosController,'categorias');
  ...
  public function deleteCategoriasController(){
   ...
   #pedir la informacion al modelo.
   $categorias = new CategoriasModel;
      $respuesta = $categorias->deleteCategoriasModel($datosController,'categorias');
      if ($respuesta == 'success') {
